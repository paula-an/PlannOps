...
def main_tep_gwo(data_file: str, name_file_test: str=None):
...
if __name__ == "__main__":
    ...
    if is_for_testing:
        ...
        main_tep_gwo(data_file=data_file, name_file_test=name_file_test)
    else:
        main_tep_gwo(data_file=data_file)
